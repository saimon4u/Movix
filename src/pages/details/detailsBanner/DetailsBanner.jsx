...
const DetailsBanner = ({ video, crew }) => {
    ...
    const writers = crew?.filter((f) => f.job === 'Screenplay' || f.job === 'Story' || f.job === 'Writer' || f.job === 'Writing');
                                        ...
                                        <div className="info">
                                            ...
                                            {(data.release_date || data.first_air_date) && (
                                                <div className="infoItem">
                                                    ...
                                                    <span className="text">{dayjs(data.release_dat || data.first_air_date).format('MMM D, YYYY')}</span>
                                                </div>
                                            )}
                                            {data.runtime && (
                                                <div className="infoItem">
